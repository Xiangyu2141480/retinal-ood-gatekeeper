...
| --- | --- | --- | --- | --- | --- |
| reports/dissertation_final/recommended_model_summary.md | Recommended model summary | Results Overview | main text | must_include | Gives the final recommended Stage 1 and Stage 2 methods in one table. |
| reports/dissertation_final/stage1_method_summary.md | Stage 1 method summary | Stage 1 Results | main text | must_include | Compact comparison of AUROC, AUPRC, FPR@95%TPR, OOD recall, and use case. |
| reports/dissertation_final/stage2_method_summary.md | Stage 2 method summary | Stage 2 Results | main text | must_include | Compact comparison of family and subtype reason-attribution methods. |
| reports/dissertation_final/limitations_summary.md | Limitations summary | Discussion | main text | must_include | Thesis-safe limitation wording for synthetic fallback and Stage 2 explanation. |
| reports/dissertation_final/claim_evidence_matrix.md | Claim evidence matrix | Discussion / Appendix | main text or appendix | must_include | Maps claims to committed evidence and limitations. |
| reports/dissertation_results/multi_scheme_comparison/metrics_by_scheme.md | Full Stage 1 metrics | Stage 1 Results | appendix | backup | Complete Stage 1 metrics for all schemes. |
| reports/dissertation_results/multi_scheme_comparison/model_selection_summary.md | Model selection summary | Stage 1 Results | appendix | recommended | Explains why Mahalanobis is primary and PatchCore is complementary. |
