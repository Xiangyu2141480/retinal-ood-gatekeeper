...
Stage 2 uses OOD taxonomy labels from:

- `datasets/dissertation_v1/manifests/reason_train.csv`
- `datasets/dissertation_v1/manifests/reason_val.csv`
- `datasets/dissertation_v1/manifests/reason_test.csv`
...
Current dataset v1 results using deterministic image-statistics features and logistic regression:
